...
{watchModels.map((watch, index)=>(
    ...
    ${index === 2 ? 'hidden md:flex': ''}`}>
            ...
            <img src={watch.imgs[0]} alt={watch.name} className='absolute
           w-full h-full object-contain opacity-100 group-hover:opacity-0 transition duration-300' />

           <img src={watch.imgs[1]} alt={watch.name} className='absolute
           w-full h-full object-contain opacity-0 group-hover:opacity-100 transition duration-300 ' />
    </div>   
